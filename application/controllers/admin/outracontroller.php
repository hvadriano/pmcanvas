...
class Outracontroller extends CI_Controller {
	
	// contrutor // function __construct()
	function Outracontroller(){
	...
	public function index()
	{
		...
		$data['page_title']  = "Outra Controller";
		$data['content'] = "Exemplo de uma outra controller e view.";
		
		// Load View
		$this->templateadmin->show('admin/outracontroller/index', $data);
	}
