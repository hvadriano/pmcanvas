...
{
	public function PermissaoModel()
	{
		parent::__construct();
     ...
     * @name $_table
     */
    protected $_table = 'tbl_permissao';
     ...
     * @name $_pk
     */
    protected $_pk 			= 'per_id';
    protected $_nome 		= 'per_nome';
    ...
    {
    	$this->db->where($this->_nome, $nome);
    	$get = $this->db->get($this->_table);
    	
    	return $get->row_array();
    }
    
    public function getByFuncionalidade($funcionalidadeId = false)
    {
    	$res = array();
    	
    	try {
    		
    		$sql = "SELECT tbl_permissao.*, tbl_grupo.* 
