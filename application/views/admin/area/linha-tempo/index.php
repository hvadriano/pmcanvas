<div class="col-md-12 pmcarea_item pmcarea_item_form" id="pmcarea_linhatempo">

	<h2>
		<span class="title">Linha do Tempo</span>
		<input type="hidden" class="area" value="12" />
		<a href="#modal" data-toggle="modal" class="pull-right addcard"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
	</h2>
	
	<div id="div_linhatempo" class="pmcareahover">
		
		<?php if ( isset( $cards['_linhatempo'] ) ) : ?>
		<?php foreach ( $cards['_linhatempo'] as $key=>$card ) :?>
