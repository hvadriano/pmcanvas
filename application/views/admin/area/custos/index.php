<div class="col-md-12 pmcarea_item pmcarea_item_form" id="pmcarea_custos">

	<h2>
		<span class="title">Custos</span>
		<input type="hidden" class="area" value="13" />
		<a href="#modal" data-toggle="modal" class="pull-right addcard"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
	</h2>
	
	<div id="div_custos" class="pmcareahover">
		
		<?php if ( isset( $cards['_custos'] ) ) : ?>
		<?php foreach ( $cards['_custos'] as $key=>$card ) :?>
