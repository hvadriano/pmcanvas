<div class="col-md-12 pmcarea_item pmcarea_item_form" id="pmcarea_requisitos">
	...
	<div id="div_requisitos" class="pmcareahover">
		
		<?php if ( isset( $cards['_requisitos'] ) ) : ?>
		<?php foreach ( $cards['_requisitos'] as $key=>$card ) :?>
