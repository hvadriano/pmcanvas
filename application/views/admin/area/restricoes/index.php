<div class="col-md-12 pmcarea_item2 pmcarea_item_form" id="pmcarea_restricoes">

	<h2>
		<span class="title">Restri&ccedil;&otilde;es</span>
	...
	<div id="div_restricoes" class="pmcareahover">
		
		<?php if ( isset( $cards['_restricoes'] ) ) : ?>
		<?php foreach ( $cards['_restricoes'] as $key=>$card ) :?>
