<div class="col-md-12 pmcarea_item pmcarea_item_form" id="pmcarea_justificativa">

	<h2>
		<span class="title">Justificativas</span>
	...
	<div id="div_justificativa" class="pmcareahover">
		
		<?php if ( isset( $cards['_justificativas'] ) ) : ?>
		<?php foreach ( $cards['_justificativas'] as $key=>$card ) :?>
