<div class="col-md-12 pmcarea_item pmcarea_item_form" id="pmcarea_riscos">

	<h2>
		<span class="title">Riscos</span>
		<input type="hidden" class="area" value="11" />
		<a href="#modal" data-toggle="modal" class="pull-right addcard"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
	</h2>
	
	<div id="div_riscos" class="pmcareahover">
		
		<?php if ( isset( $cards['_riscos'] ) ) : ?>
		<?php foreach ( $cards['_riscos'] as $key=>$card ) :?>
