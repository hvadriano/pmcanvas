<div class="col-md-12 pmcarea_item2 pmcarea_item_form" id="pmcarea_equipe">
	...
	<div id="div_equipe" class="pmcareahover">
		
		<?php if ( isset( $cards['_equipe'] ) ) : ?>
		<?php foreach ( $cards['_equipe'] as $key=>$card ) :?>
