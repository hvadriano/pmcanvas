<div class="col-md-12 pmcarea_item2 pmcarea_item_form" id="pmcarea_stakeholders">
	...
	<div id="div_stakeholders" class="pmcareahover">
		
		<?php if ( isset( $cards['_stakeholders'] ) ) : ?>
		<?php foreach ( $cards['_stakeholders'] as $key=>$card ) :?>
